...
void Page::makeTemplate() {
    ...
    view->appendInSubview("head",
                          *new SecondaryView("attributesForCSS0",Type::LINK,std::vector<Attribute>{
                                  ...
                                  Attribute("rel","stylesheet"),
                                  Attribute("type","/Static/text/css")
                          }));
    view->appendInSubview("head",
    ...
    view->appendInSubview("head",
                          *new SecondaryView("jsScripts0",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","Static/vendor/jquery/jquery.min.js"),
                          }));

    view->appendInSubview("head",
                          *new SecondaryView("jsScripts1",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","/Static/vendor/bootstrap/js/bootstrap.bundle.min.js"),
                          }));
    view->appendInSubview("head",
                          *new SecondaryView("jsScripts2",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","/Static/vendor/jquery-easing/jquery.easing.min.js"),
                          }));

    view->appendInSubview("head",
                          *new SecondaryView("jsScripts3",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","/Static/js/jqBootstrapValidation.js"),
                          }));

    view->appendInSubview("head",
                          *new SecondaryView("jsScripts4",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.14/angular.min.js"),
                          }));
    view->appendInSubview("head",
                          *new SecondaryView("jsScripts5",Type::SCRIPT,std::vector<Attribute>{
                                  Attribute("src","/Static/js/freelancer.min.js"),
                          }));
